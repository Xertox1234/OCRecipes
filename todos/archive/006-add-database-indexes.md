...
export const scannedItemsUserIdIdx = index("scanned_items_user_id_idx").on(
  scannedItems.userId,
);
export const scannedItemsScannedAtIdx = index(
  "scanned_items_scanned_at_idx",
).on(scannedItems.scannedAt);
export const dailyLogsUserIdIdx = index("daily_logs_user_id_idx").on(
  dailyLogs.userId,
);
export const dailyLogsLoggedAtIdx = index("daily_logs_logged_at_idx").on(
  dailyLogs.loggedAt,
);
```
