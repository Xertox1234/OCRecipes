...
- [x] Replace serial per-user awaits with bounded parallelism or storage-level batch helpers.
- [x] Preserve idempotency and duplicate-reminder protection.
- [x] Keep per-user failures isolated and logged with user context.
- [x] Add or update tests for muted users, already-pending reminders, and users needing reminders.
