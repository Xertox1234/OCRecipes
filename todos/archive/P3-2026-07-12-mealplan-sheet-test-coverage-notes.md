...
- [x] Add a one-line note to `MealPlanHomeScreen.test.tsx`'s header stating that the suite
...
- [x] Add a one-line note to `test/mocks/react-native-svg.ts` stating the mock spreads props
