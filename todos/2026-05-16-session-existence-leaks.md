...
- [ ] Return `404` for missing or cross-user photo analysis sessions.
- [ ] Return `404` for missing or cross-user label/verification sessions.
- [ ] Keep response bodies consistent with existing not-found behavior.
- [ ] Add route tests for another-user session IDs where practical.
