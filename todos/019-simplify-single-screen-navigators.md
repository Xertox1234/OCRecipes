...
- [ ] Evaluate if additional screens are planned for these stacks
- [ ] If no screens planned, inline screens directly in MainTabNavigator
- [ ] If screens planned, keep current structure (no action needed)
