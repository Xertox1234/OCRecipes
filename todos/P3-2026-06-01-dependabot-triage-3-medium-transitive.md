...
- esbuild item: the related postcss bundler-verify todo is now closed (`todos/archive/P3-2026-05-31-postcss-override-bundler-verify.md`). Trigger is `drizzle-kit` 1.0 stable (drops `@esbuild-kit`), independent of any Expo SDK or drizzle-orm/zod upgrade.
