...
| Grocery lists        | `plan/grocery-list.yaml`                             | **Partial**: Plan → Grocery Lists screen renders (FAB asserted, error state excluded) and the create-list picker opens; whether a list actually generates is seeded-data-dependent and stays optional |
