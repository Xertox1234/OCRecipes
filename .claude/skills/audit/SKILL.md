...
**Audit PR body template** (summary only — fill from the manifest):

```
## Summary
[scope] audit — N findings fixed, M deferred to todos.

## Fixed
- <one line per verified finding, from the manifest>
