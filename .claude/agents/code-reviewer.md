...
- [ ] **Agent/skill prose that states repo facts: verify the predicate, not the symbol** — for each cited convention, check the claim's relationship (order, exclusivity, tier/attribution) at the source; a green grep for the identifier proves nothing (four such defects passed a symbol-existence fact-check in PR #512). A cited count/precedent ("PR #14: 3 findings") is a predicate too — re-derive it under one stated counting method, or require the doc to cite the source commit instead (PR #577 shipped a miscount in a discipline table's "Reality" cell). For read-only agents, also check every binding `docs/rules/<domain>.md` they operate under has an explicit read-directly pointer — injection never fires for them, and restated rule content drifts. (Ref: `docs/solutions/logic-errors/symbol-existence-grep-is-not-claim-verification-2026-07-05.md`, `docs/solutions/conventions/agent-file-edits-take-effect-on-reload-not-save-2026-07-02.md`)
