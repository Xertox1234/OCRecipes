...
| DRIFT-003 | Inline codification targets          | monthly   | pending | —            | —          | `.claude/agents/todo-executor.md`, `.claude/skills/audit/SKILL.md`, `.claude/skills/codify/SKILL.md` | Confirm codification targets `docs/solutions/<category>/<slug>-<YYYY-MM-DD>.md` (per `.claude/skills/codify/SKILL.md` Steps 5-6), `.claude/agents/code-reviewer.md`, and specialist agents. Flag any references that still point at `docs/legacy-patterns/*.md` or `docs/LEARNINGS.md` (those are a frozen archive — retired in the Phase 2 pattern-codification refactor — and no longer codification targets). |
