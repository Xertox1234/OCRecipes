...
symptoms:
  - "OCR replaces every uppercase S with 5, corrupting words like 'Sodium' to '5odium'"
  - "Label text is mangled outside numeric fields"
  - "Context-free character substitution applies globally"
created: 2026-04-07
severity: medium
---
