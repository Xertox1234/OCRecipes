...
symptoms: [Failed batch save leaves some recipes persisted and others missing, 'Custom user-facing error messages never appear; users see raw ''500: {error: ...}''', Internal OpenAI/database errors leak into the 5xx response body]
applies_to: [server/routes/meal-plan.ts, client/hooks/useGenerateMealPlan.ts]
created: '2026-03-10'
---
