...
symptoms:
  - "Filter works through one query path but silently no-ops through another"
  - "Cold-start / index-not-warm / bypass-flag requests return wrong filtered results"
  - "Source comment in the unfixed path reads 'this column does not exist' even though it now does"
created: 2026-04-18
severity: high
---
