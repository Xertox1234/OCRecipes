...
module: server
applies_to:
  ["server/services/grocery-generation.ts", "server/services/**/categori*.ts"]
symptoms:
  - "Compound ingredient names land in the wrong grocery category (e.g., cumin appears under meat)"
  - "First-match keyword search assigns to a generic short keyword before the specific long one is checked"
created: 2026-05-13
severity: medium
---
