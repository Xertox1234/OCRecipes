...
symptoms:
  - Same WARNING re-surfaces across consecutive `kimi-review` calls in an audit session
  - Reviewer argues about something already empirically verified
  - Per-fix reviews touch unrelated parts of the working tree
created: 2026-05-11
severity: low
---
