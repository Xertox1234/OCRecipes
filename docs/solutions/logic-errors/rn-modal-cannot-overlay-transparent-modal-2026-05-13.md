...
module: client
severity: high
tags: [react-native, modal, react-navigation, transparent-modal, ios, view-controller]
symptoms: [Modal component opens but is invisible on iOS, User taps a button inside a `transparentModal` screen and nothing appears, Same Modal works on screens that are NOT React Navigation modals]
