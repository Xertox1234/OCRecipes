...
symptoms:
  - "Rapid double-tap on a toggle button produces a duplicate row or 500 error"
  - "Unique constraint violation surfaces to the client instead of a clean toggle"
  - "Two concurrent requests both see 'no existing favourite' and both insert"
created: 2026-02-12
severity: high
---
