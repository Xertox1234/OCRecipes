...
symptoms: ['Warning: Can''t perform a React state update on an unmounted component', Memory usage grows over time, State updates after navigation away from screen]
created: '2026-02-01'
---
