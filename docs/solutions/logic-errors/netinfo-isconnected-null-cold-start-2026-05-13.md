...
symptoms: [Offline banner briefly flashes on app launch even with connectivity, isConnected check uses truthy/falsy logic on a boolean | null value, Network status flickers from offline to online in the first ~200ms]
