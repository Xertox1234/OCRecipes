...
symptoms:
  - "Error message never appears in UI despite setRequestError(errorMsg)"
  - "Set-then-clear pattern inside try/finally collapses to the cleared value"
  - "Error state set in the same synchronous frame as a finally-block reset never renders"
created: 2026-05-01
severity: high
---
