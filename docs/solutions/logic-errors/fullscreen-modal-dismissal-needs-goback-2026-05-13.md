...
symptoms:
  - "After navigating from a fullScreenModal, pressing Back returns to the modal instead of its origin"
  - "Modal stays in the navigation stack after the user moves to the destination"
  - "Back button on the destination screen has unexpected target"
created: 2026-05-09
severity: medium
---
