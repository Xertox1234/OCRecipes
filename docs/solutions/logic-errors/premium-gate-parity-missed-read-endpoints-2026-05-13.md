...
symptoms: [POST endpoints are premium-gated but sibling GET endpoints that hit the same paid API are not, Free-tier user drains a paid external-API quota by browsing, PR title and review focus on writes; the matching reads were not even opened]
