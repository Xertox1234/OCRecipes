...
symptoms:
  - "Personalization filter appears in type signature but UI never reflects it"
  - "Two prior fixes for symptoms further upstream (cache invalidation, write-through) didn't fix the bug"
  - "DB query silently ignores a parameter callers expect to filter by"
created: 2026-05-10
severity: high
---
