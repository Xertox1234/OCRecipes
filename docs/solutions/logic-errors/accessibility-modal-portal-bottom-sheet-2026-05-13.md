...
applies_to:
  [
    ...
    "client/components/**/*BottomSheet*.tsx",
  ]
symptoms:
  - "VoiceOver cannot reach a BottomSheetModal even though it is visible on screen"
  - "Screen reader skips over modal content when the screen container has accessibilityViewIsModal=true"
created: 2026-03-25
severity: high
---
