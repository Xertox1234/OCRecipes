...
symptoms: [kimi-review pre-commit hook blocks a clean commit with a phantom CRITICAL, 'Blocked output''s [CRITICAL] line is clean prose (''No critical issues found.''), not a path:line finding', A plain retry of the identical commit succeeds]
