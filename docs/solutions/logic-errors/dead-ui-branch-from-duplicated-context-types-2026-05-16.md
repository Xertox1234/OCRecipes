...
symptoms: [A client component's conditional render branch always shows the fallback, 'A service builder returns a literal null / [] / 0 for a field whose type allows real values', tsc passes but a feature's data silently never appears in the UI]
