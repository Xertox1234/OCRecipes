...
symptoms:
  - "Commit message advertises a fix that the current code does not actually implement"
  - "Earlier audit todo is marked closed but the symptom is still present"
  - "Merge conflict resolution silently dropped part of the change"
created: 2026-04-17
severity: medium
---
