...
symptoms:
  - "User sees error UI even though locally-parsed OCR items were visible"
  - "AI failure discards valid OCR results instead of letting them remain"
  - "`scanMutation.isError` flips hard error state when partial results exist"
created: 2026-04-28
severity: medium
---
