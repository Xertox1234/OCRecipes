...
symptoms:
  - "Wrong token deleted when push delivery returns an error ticket"
  - "Push ticket array indices don't align with raw token array indices"
  - "Stale push tokens accumulate because deletion targets the wrong record"
created: 2026-04-29
severity: high
---
