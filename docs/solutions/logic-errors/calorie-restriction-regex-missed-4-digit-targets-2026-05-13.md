...
symptoms:
  - "Coach safety guardrail allows '1000 calories a day' targets through"
  - "Regex catches 800-kcal targets but not 1100-kcal targets"
  - "parseInt < 1200 guard is correct but never reached for 4-digit values"
created: 2026-05-11
severity: critical
---
