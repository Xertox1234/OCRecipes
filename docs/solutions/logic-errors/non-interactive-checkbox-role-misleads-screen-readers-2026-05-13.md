...
symptoms:
  - VoiceOver/TalkBack announces a non-interactive view as "checkbox, checked" then the gesture does nothing
  - Users expect tap-to-toggle but the actionable element is a sibling button
  - Code review (round 2) escalates a checkbox-role finding to CRITICAL
created: 2026-05-10
severity: high
---
...
- `docs/patterns/react-native.md` — "Parent Label Prefix for Decorative Child Elements"
