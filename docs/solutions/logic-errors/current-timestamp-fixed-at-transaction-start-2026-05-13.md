...
symptoms:
  - "ORDER BY created_at DESC returns rows in arbitrary order in tests"
  - "Two rows inserted with await sleep(50ms) between them get identical createdAt"
  - "Test passes when run individually but fails in suite due to shared transaction"
created: 2026-05-10
severity: medium
---
