...
symptoms:
  - "TS error: `Argument of type 'undefined' is not assignable to parameter of type ...`"
  - "`useRef<T>()` with no argument breaks the build after upgrading to React 19"
  - "Timer refs that worked under React 18 fail to compile"
created: 2026-05-13
severity: medium
---
