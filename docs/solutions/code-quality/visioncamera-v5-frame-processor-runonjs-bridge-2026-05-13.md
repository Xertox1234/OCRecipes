...
symptoms:
  - "useFrameProcessor() no longer exists after V5 upgrade"
  - "Third-party OCR plugin types don't match V5's Frame export"
  - "Frame pipeline stalls when frames are not disposed"
created: 2026-05-03
severity: medium
---
