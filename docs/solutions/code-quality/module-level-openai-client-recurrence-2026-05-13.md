...
symptoms: [Any test importing the service file crashes because AI_INTEGRATIONS_OPENAI_API_KEY is missing, Pure helper functions in service files can't be unit-tested in isolation, The same anti-pattern appears in 7 of 8 AI service files]
