...
symptoms:
  - "UI cycle (tips, animations, prompts) starts at the wrong index after a hot reload"
  - "Counter survives between mount/unmount, breaking expected reset semantics"
  - "Behavior diverges between dev (Fast Refresh) and production"
created: 2026-03-21
severity: low
---
