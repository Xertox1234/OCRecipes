...
symptoms:
  - "React Native bundle pulls `jsonwebtoken` and Node `crypto` polyfills"
  - "`shared/` file imports a server-only package"
  - "Bundle size increases unexpectedly after a 'pure types' refactor"
created: 2026-03-27
severity: medium
---
