...
module: shared
severity: medium
tags: [drizzle, drizzle-zod, jsonb, nullable, type-safety, typescript, shared-schema]
symptoms: [TS2769 'No overload matches this call' at db.insert(table).values(...), Type 'string' is not assignable to ... allergens, 'Column type widens to ''DerivedRecipeAllergen[] | Json | undefined''']
