---
title: audit-lsp-verification-read-and-write-side
track: knowledge
category: conventions
module: shared
tags: [lsp, code-audit, verification, review-workflow, tooling]
applies_to: [.claude/skills/audit/SKILL.md, docs/rules/lsp.md]
created: '2026-05-20'
---
