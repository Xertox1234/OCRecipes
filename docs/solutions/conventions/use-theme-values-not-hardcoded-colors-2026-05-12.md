...
symptoms:
  - 'Hex color literals or named colors (e.g. "#FFFFFF", "white") inline in style values'
  - "Component renders correctly in light mode but breaks visually in dark mode"
  - "Same colour value duplicated across multiple files instead of one theme key"
created: 2026-05-12
severity: medium
---
