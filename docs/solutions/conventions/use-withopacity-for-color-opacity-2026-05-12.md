...
symptoms: [Hex strings concatenated with a two-char opacity suffix (theme.color + '20'), Magic two-character hex suffixes appearing inline in style values, Reviewer comments noting 'this looks like 20% but it's actually 12.5%']
