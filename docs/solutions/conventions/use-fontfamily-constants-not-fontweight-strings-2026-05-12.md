...
symptoms:
  - "fontWeight: '600' / '500' / 'bold' in style blocks"
  - "Android text weight appears wrong (synthesised bold instead of true Poppins SemiBold)"
  - "Letter spacing or stroke width differs between iOS and Android for the same component"
created: 2026-05-12
severity: medium
---
