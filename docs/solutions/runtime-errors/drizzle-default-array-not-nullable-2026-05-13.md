...
symptoms:
  - "Calling .filter/.map on an array column crashes at runtime with `Cannot read properties of null`"
  - "TypeScript inferred type is string[] | null despite `.default([])`"
  - "Legacy NULL rows trigger TypeErrors after a column was migrated to have a default"
created: 2026-05-09
severity: high
---
