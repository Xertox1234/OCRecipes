...
symptoms:
  - "TypeError: maxLoggedAt.toISOString is not a function"
  - "Compiles cleanly but crashes on the first real request"
  - "Aggregate of timestamp column returns string at runtime"
created: 2026-03-21
severity: critical
---
