...
symptoms:
  - "Zod z.number() validation fails on every authenticated request"
  - "500 error on routes that parse `req.userId`"
  - "TypeScript happy because parseInt returns number — but NaN is a number"
created: 2026-04-28
severity: high
---
