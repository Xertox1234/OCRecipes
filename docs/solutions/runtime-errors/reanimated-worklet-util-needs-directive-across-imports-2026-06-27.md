...
- Optional automated guard tracked in `todos/archive/P3-2026-06-27-guard-worklet-directive-on-cross-import-worklet-calls.md` — implemented as `scripts/worklet-directive-guard.ts` / `scripts/__tests__/worklet-directive-guard.test.ts`.
