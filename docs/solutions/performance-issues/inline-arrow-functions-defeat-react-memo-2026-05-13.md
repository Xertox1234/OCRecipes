...
symptoms:
  - "Every row in a memoized FlatList re-renders on every parent state change"
  - "Scroll jank scales with list length"
  - "React DevTools 'Highlight updates' shows full-list flashes even when one item changed"
created: 2026-02-12
severity: medium
---
