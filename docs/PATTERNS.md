...
| API           | [api.md](patterns/api.md)                     | Error responses, auth, env validation, service availability guards, graceful shutdown, rate limiters, external API handling                  |
...
| Architecture  | [architecture.md](patterns/architecture.md)   | Storage module decomposition, route registration, service patterns, session store factory, storage layer purity                              |
