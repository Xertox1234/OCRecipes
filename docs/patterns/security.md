...
**References:** `server/services/coach-intent-classifier.ts` — all three fixes applied with regression tests in `server/services/__tests__/coach-intent-classifier.test.ts`
